        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git branch: 'master', url: 'https://github.com/kireobat/fish-time-web.git'
                }
            }
        }
            ...
            steps {
                script {
                    ...
                    docker.withRegistry('https://index.docker.io/v1/', 'dockerhub') {
                        def app = docker.build("kireobat/fish-time-web")
                    ...
                    script {
                        ...
                        def createContainer = { token, name, hostPort ->
                            ...
                            def deployResponse = httpRequest(
                                ...
                                customHeaders: [[name: 'Authorization', value: "Bearer ${token}"]],
                                requestBody: """{
                                    "Image": "kireobat/fish-time-web:latest",
                                    "HostConfig": {
                                        "PortBindings": {
                        ...
                        def containerName = "fish-time-web"
                        def hostPort = null
